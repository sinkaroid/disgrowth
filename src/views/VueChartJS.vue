  ...
  <section class="container">
    ...
    <div class="columns">
      <div class="column">
        ...
        <h2>Approximate new servers in a day: <code>+{{ average_server_growth_daily }}</code></h2>
      </div>
      <div class="column">
        <h3>🎉Votes Growth</h3>
        <h1>
        ...
        <h2>Approximate <a href="https://support.top.gg/support/solutions/articles/73000528198-using-your-vote-credit#:~:text=What%20are%20Vote%20Credits%3F,vote%20credit%20as%20a%20reward.">Top.gg credits</a>: <code>{{ approximate_credits_rewards_monthly }}</code></h2>
      </div>
      
    </div>
    <h3>According this statistics it can be concluded, {{ name }} will get <font color="red"><b>+{{ approximate_server_growth_three_months }}</b></font> server growth in the next 3 months</h3>
    <h2>Then will get <font color="red"><b>+{{ approximate_server_growth_annually }}</b></font> server growth in the next year</h2>
  ...
  export default {
    ...
    async created () {
      ...
      .then((response) => {
        ...
        this.average_server_growth_monthly = response.average_server_growth_monthly
        ...
        this.approximate_server_growth_three_months = response.approximate_server_growth_three_months
        this.approximate_credits_rewards_monthly = response.approximate_credits_rewards_monthly
        this.approximate_server_growth_annually = response.approximate_server_growth_annually
